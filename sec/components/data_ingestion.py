...
from sec.components.model_trainer import ModelTrainerConfig
from sec.components.model_trainer import ModelTrainer
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv(r'C:\Users\91989\OneDrive\Desktop\PROJECTS\mlproject\notebook\data\stud.csv')
